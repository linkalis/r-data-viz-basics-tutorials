...
4. Now, we want to figure out which building has the the lowest greenhouse gas emissions based on its floor area ("floor\_area").  Create a new variable called "GHG\_emissions\_by\_floor\_area" using the following formula: `GHG_emissions_by_floor_area = total_GHG_emissions / floor_area`.  Save this variable as a new column back to the original dataset.  Then, sort the data to find out which building has lowest the greenhouse gas emissions based on its floor area.
